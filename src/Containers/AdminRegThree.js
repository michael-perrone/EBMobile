...
function AdminRegThree(props) {
    return (
        <View style={{ alignItems: 'center' }}>
            ...
            <Input onChangeText={props.getFullName} secureTextEntry={true} placeholder={"Full Name"} width={utils.width / 1.4} />
            <Input onChangeText={props.getEmail} secureTextEntry={true} placeholder={"Email"} width={utils.width / 1.4} />
